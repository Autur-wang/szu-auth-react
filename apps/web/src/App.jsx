...
import { Button, Dialog } from 'animal-crossing-ui';
...
const BOOKING_DEMO_PATH = '/docs/szu-booking/index.html';
...
function redirectToBookingDemo(delay = 0) {
  window.setTimeout(() => {
    window.location.assign(BOOKING_DEMO_PATH);
  }, delay);
}
